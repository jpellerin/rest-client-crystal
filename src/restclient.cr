...
require "./restclient/utils"
require "./restclient/request"
require "./restclient/abstract_response"
require "./restclient/response"
require "./restclient/raw_response"
require "./restclient/resource"
require "./restclient/payload"
require "./restclient/windows"
...
module RestClient
  ...
  def self.patch(url, payload, headers=nil, &block)
  ...
  def self.options(url, headers=nil, &block)
  ...
  def self.create_log param
    # TODO(jhp) handle string param loggers
    # if param
  ...
  @@before_execution_procs = [] of Proc
